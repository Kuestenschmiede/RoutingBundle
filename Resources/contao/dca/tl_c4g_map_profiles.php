...
$GLOBALS['TL_DCA']['tl_c4g_map_profiles']['palettes']['default'] = str_replace('geosearch_results_div;','geosearch_results_div;{routing_legend:hide},routerConfig;', $GLOBALS['TL_DCA']['tl_c4g_map_profiles']['palettes']['default']);
