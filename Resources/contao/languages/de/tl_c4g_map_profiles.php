...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['router_api_key'] = ['API-Key', 'Geben Sie hier Ihren ORS- oder Graphopper-API-Key ein. Den Key können Sie <a href="https://openrouteservice.org/sign-up/" target="_blank">hier (OpenRouteService)</a>  oder <a href="https://graphhopper.com/dashboard/#/register" target="_blank"> hier (Graphhopper)</a> generieren. Achten Sie auf die Servicebeschränkungen.'];
